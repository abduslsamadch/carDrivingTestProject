...
*/
	...
	FrontLeftWheel.motorTorque = 0- (EngineTorque / GearRatio[CurrentGear] * Input.GetAxis("Vertical")); //Returns the value of the virtual axis identified by axisName.
	FrontRightWheel.motorTorque = 0-(EngineTorque / GearRatio[CurrentGear] * Input.GetAxis("Vertical"));
